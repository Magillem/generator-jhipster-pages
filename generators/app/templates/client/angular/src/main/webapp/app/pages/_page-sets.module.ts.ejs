...
import { <%= angularXAppName %><%= currentPageSet.pageSetAngularClass %>Module } from './<%= currentPageSet.pageSetFolder %>/<%= currentPageSet.pageSetAngularFileName %>.module';
<%_ } _%>
...
export class <%=angularXAppName%>PageSetsModule {}
